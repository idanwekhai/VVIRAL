...
# with open('AAV2_AAVA3_campaign_purity_yield.json', 'w', encoding='utf-8') as f:
#     json.dump(campaign_json, f, ensure_ascii=False, indent=4)

# new_add = pd.read_csv("process_file.csv")
...
# with open('AAV2_AAVA3_campaign_purity_yield.json', 'r') as f:
